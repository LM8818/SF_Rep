...
from app.api.api_v1.endpoints import nlp, prompts  # noqa: F401
...
api_router.include_router(
    prompts.router,      # сам роутер
    prefix="/prompts",   # общий префикс → /api/v1/prompts/…
    tags=["prompts"],    # тег в Swagger-документации
)
